  ...
  return (
    <div className="mt-32 mx-20">
      ...
      <form className="flex flex-col w-max mt-8">
        ...
        <Input
          placeholder=""
          className="bg-white rounded-full w-96 text-black text-2xl mt-5"
        />
        <label className="font-bold text-3xl mt-12">Subject</label>
        <Input
          placeholder=""
          className="bg-white rounded-full w-96 text-black mt-5"
        />
        <label className="font-bold text-3xl mt-12">Message</label>
        <textarea
          className="bg-white rounded-xl w-96 h-40 text-black text-2xl mt-5 p-4"
          placeholder=""
        />
